    ...
    <div class="container-fluid">
        <div class="row">
            <ul class="nav nav-tabs justified" style="background-color:rgb(204, 248, 212);">
                <li class="nav-item ">
                    <a class="nav-link active" aria-current="page" style="background-color:white" href="#"><b>Automobile</b></a>
                </li>
    ...
    <div class="container mx-0">
        <div class="row mx-0">
            ...
            <div class="col-sm side-2">
                <center><h2><b>Mercedes Benz</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Toyota</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
