    ...
    <div class="container mx-0">
        <div class="row mx-0">
            ...
            <div class="col-sm side-2">
                <center><h2><b>Kitchen</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Office Furniture</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Interior decor</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Office Products</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Home Appliances</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
