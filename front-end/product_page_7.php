    ...
    <div class="container mx-0">
        <div class="row mx-0">
            ...
            <div class="col-sm side-2">
                ...
                <hr>
                <center><h2><b>Stereo</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Air conditioners</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Kenwood Appliances</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Phillip's Appliances</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Other Appliances</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
