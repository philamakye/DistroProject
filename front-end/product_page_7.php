    ...
    <div class="container-fluid">
        <div class="row">
            <ul class="nav nav-tabs justified" style="background-color:rgb(204, 248, 212);">
                <li class="nav-item ">
                    <a class="nav-link active" aria-current="page" style="background-color:white" href="#"><b>Electronics</b></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="product_page.php_1" style="color:rgb(70, 74, 87);" role="button" aria-expanded="false"><i class="fas fa-tshirt" style="padding-right: 3px;"></i>Fashion</a>
    ...
    <div class="container mx-0">
        <div class="row mx-0">
            ...
            <div class="col-sm side-2">
                ...
                <hr>
                <center>
                    <h2><b>Phillip's Appliances</b></h2>
                </center>
                <hr>
                <div class="container">
                    <div class="row">
