    ...
    <div class="container mx-0">
        <div class="row mx-0">
            ...
            <div class="col-sm side-2">
                <center><h2><b>Shirts</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Trousers</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Dresses</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <hr>
                <center><h2><b>Underwears</b></h2></center>
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
